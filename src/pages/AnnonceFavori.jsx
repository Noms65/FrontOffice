                ...
                <Grid container spacing={1} style={{ backgroundColor: 'gray' }}>
                    ...
                    <Grid item xs={12} lg={10} style={{ padding: '10px' }}>
                        ...
                        <Grid container item xs={12} justifyContent="space-between">
                            ...
                            <p>tarif: {tarif}</p>
                            <p>carburant: {carburant.nom}</p>
                            <p>categorieVoiture: {categorieVoiture.nom}</p>
                            <p>modeleVoiture: {modeleVoiture.nom}</p>
                            <p>utilisateur: {utilisateur.email}</p>
                        </Grid>
...
const AnnonceFavori = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("https://autotrader-production-a56f.up.railway.app/api/mes/favoris", {
                    method: 'GET',
                    headers: {
